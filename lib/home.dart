...
import 'package:flutter_application_api/post.dart';
                ...
                return Padding(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(snapshot.data?[index].body ?? 'subtitle'),
                      leading:
                          Text(snapshot.data?[index].id.toString() ?? 'id'),
                    ),
                  ),
                );
              },
